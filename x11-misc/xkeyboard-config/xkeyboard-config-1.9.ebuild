...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/xkeyboard-config/xkeyboard-config-1.9.ebuild,v 1.3 2010/07/12 11:18:10 hwoarang Exp $
...
src_prepare() {
	epatch "${FILESDIR}/ru-yawerty-${PV}.patch"
}
