...
SRC_URI="http://gentoo.coderazor.org/python-gentoo-patches-${PV/_r*/}-r2.tar.bz2"
...
src_unpack() {
	...
	if tc-is-cross-compiler ; then
		...
		rm "${WORKDIR}/${PV/_r*/}"/*-cross-compilation*.patch
	fi

	EPATCH_FORCE="yes" EPATCH_SUFFIX="patch" epatch "${WORKDIR}/${PV/_r*/}"
