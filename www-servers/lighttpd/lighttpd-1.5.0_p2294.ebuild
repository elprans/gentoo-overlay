...
SRC_URI="http://opensu.se/~darix/lighttpd/${P%_p*}.prerelease.r${P##*_p}.tar.bz2"

LICENSE="BSD"
SLOT="0"
KEYWORDS="~amd64 ~hppa ~ppc ~ppc64 ~sparc ~sparc-fbsd ~x86 ~x86-fbsd"
IUSE="bzip2 doc fam fastcgi gdbm ipv6 ldap lua minimal memcache mysql pcre
pic php postgres rrdtool ssl test valgrind webdav xattr"
